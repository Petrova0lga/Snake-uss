...
//Создать класс препятствия для змейки и конец игры после врезания в препятствие
...
namespace Snake
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            Sounds sounds = new Sounds(@"C:\Users\OlgaPetrova\source\repos\SnakeC\SnakeC\Resources\");
