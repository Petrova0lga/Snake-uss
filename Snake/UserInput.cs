...
namespace Snake
    {   //saving the data of player (name,score) to the file and reading the data from this file, writing to the screen 
        ...
        {
            private string scoresFile = "C:\\Users\\OlgaPetrova\\source\\repos\\SnakeC\\SnakeC\\Nimed.txt";
            ...
            { //*Writes the scores to te txt file
                ...
                using (StreamWriter writer = new StreamWriter(@"C:\Users\OlgaPetrova\source\repos\SnakeC\SnakeC\Nimed.txt", true))
                {
        ...
        public static void PrintHighScores() //reads the lines from the txt and writes them to the screen by decreasing order
        {
            try
            {
                string[] lines = File.ReadAllLines(@"C:\Users\OlgaPetrova\source\repos\SnakeC\SnakeC\Nimed.txt");
